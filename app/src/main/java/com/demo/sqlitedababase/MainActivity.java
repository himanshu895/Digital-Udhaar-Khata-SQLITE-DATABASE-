...
public class MainActivity extends AppCompatActivity {
    ...
    Button bt_save,viewdata,viewdatall,sms;
...
sms.setOnClickListener(new View.OnClickListener() {
    ...
    public void onClick(View v) {
        ...
        i.putExtra(Intent.EXTRA_SUBJECT,"Good Afternoon Bro");
        i.putExtra(Intent.EXTRA_TEXT,"You gave to (  ) to Himanshu(7705983536) with cash ");
